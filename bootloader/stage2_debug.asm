; Stage 2 Bootloader: Loads the kernel from disk into memory and switches to
    ...
    cli
	    ...
	    mov ds, ax
		    ...
		    mov ss, ax
			    ...
			    ; Load kernel KERNEL_SECTORS sectors from
			    ; LBA=KERNEL_LBA to 0x100000
			        mov si, 0                  ; sector counter
				(offset)
				    mov di, KERNEL_SECTORS     ; total number of
				    sectors
