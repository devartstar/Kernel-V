...
# --- Debug Symbols ---
debug-symbols: $(STAGE1_ELF) $(STAGE2_ELF) $(KERNEL_ELF) ## Build all debug symbols
...
debug-stage1: $(STAGE1_ELF) $(DISK_IMG) ## Debug Stage 1 bootloader
...
debug-stage2: $(STAGE2_ELF) $(DISK_IMG) ## Debug Stage 2 bootloader  
	$(ECHO) "Starting QEMU for Stage2 debugging..."
	$(ECHO) "Connect with: $(GDB) -x tools/gdb/stage2.gdb"
	$(Q)$(QEMU) -drive format=raw,file=$(DISK_IMG) -s -S -display curses

debug-bootloader: $(STAGE1_ELF) $(STAGE2_ELF) $(DISK_IMG) ## Debug both bootloader stages
	$(ECHO) "Starting QEMU for bootloader debugging..."
	$(ECHO) "Connect with: $(GDB) -x tools/gdb/bootloader.gdb"
	$(Q)$(QEMU) -drive format=raw,file=$(DISK_IMG) -s -S -display curses

debug-kernel: $(KERNEL_ELF) $(DISK_IMG) ## Debug kernel only
