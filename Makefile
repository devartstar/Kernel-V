...
# 			nasm -f bin $< -o $@
#
# 			$(BUILDDIR)/kernel_entry.o: $(KERNEL_ENTRY_SRC) |
# 			$(BUILDDIR)
# 				nasm -f elf32 $< -o $@
#
# 				$(BUILDDIR)/kernel.o: $(KERNEL_MAIN_SRC) |
# 				$(BUILDDIR)
# 					gcc -m32 -ffreestanding -c $< -o $@
#
# 					$(KERNEL_BIN):
# 					$(BUILDDIR)/kernel_entry.o
# 					$(BUILDDIR)/kernel.o $(KERNEL_LD) |
# 					$(BUILDDIR)
# 						ld -m elf_i386 -T $(KERNEL_LD)
# 						-o $@ $(BUILDDIR)/kernel_entry.o
# 						$(BUILDDIR)/kernel.o
#
# 						$(DISK_IMG): $(STAGE1_BIN)
# 						$(STAGE2_BIN) $(KERNEL_BIN) |
# 						$(BUILDDIR)
# 							dd if=/dev/zero of=$@
# 							bs=1K count=1440
# 								dd
